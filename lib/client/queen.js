...
Queen.prototype.messageHandler = function(message){
	switch(message[0]){
		...
		case MESSAGE_TYPE['worker provider message']:
			this.workerProviderMessageHandler(message[1], message[2]);
			break;

		case MESSAGE_TYPE['create worker provider']:
			this.workerProviderHandler(message[1], message[2]);
			break;
...
Queen.prototype.workforceMessageHandler = function(workforceId, message){
...
Queen.prototype.workerProviderMessageHandler = function(workerProviderId, message){
...
Queen.prototype.workerProviderHandler = function(id, attributes){
	var	self = this, 
