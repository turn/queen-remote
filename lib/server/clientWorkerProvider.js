...
var ClientWorkerProvider = function(workerProvider, onSendToSocket){
	precondition.checkDefined(workerProvider, "WorkerProviders requires a concrete queen worker provider");
	precondition.checkType(typeof onSendToSocket == "function", "WorkerProviders requires a onSendToSocket function");
